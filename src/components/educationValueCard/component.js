...
const EducationValueCard = ({ valueCollege }) => {
  ...
  return (
    <div className='flex flex-col relative'>
      <div className={`w-[335px] sm:w-full min-h-[551px] h-auto p-[25px] flex flex-col justify-between items-center ${path === `/${lang}/education-activity` ? 'border-[#0072BC] border-[1px]' : 'shadow-lg'} rounded-[5px] shadow-lg`}
      >
        <img src={valueCollege?.image} alt={valueCollege?.title} className='w-full h-[196px]' />
